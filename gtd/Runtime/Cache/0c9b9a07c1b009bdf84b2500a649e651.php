        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="<?php echo ($active["2"]); ?>"><a href="#">备忘录</a></li>
              <li class="<?php echo ($active["3"]); ?>"><a href="#">参考资料</a></li>
...
<div class="container">
      ...
      <form class="form-signin" method="POST" action="__URL__/add_material_post">
        <h2 class="form-signin-heading">新建材料</h2>
        <label for="inputContent" class="sr-only">材料概述</label>
        <textarea type="text" name="content" id="inputContent" class="form-control" placeholder="材料概述" required></textarea>
        <p></p>
