...
class RenrenSDK extends ThinkOauth{
	...
	//protected $Authorize = 'scope=publish_feed%2Bphoto_upload%2Bread_user_status%2Bread_user_album%2Bcreate_album%2Bread_user_photo';
	protected $Authorize='scope=publish_feed+photo_upload+read_user_status+read_user_album+create_album+read_user_photo';
	...
	public function call($api, $param = '', $method = 'GET', $multi = false){
		...
		//var_dump($this->url($api,''), $this->param($params, $param));
